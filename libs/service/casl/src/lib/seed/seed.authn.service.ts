...
import { ActionEnum, AuthPrismaService, StatusEnum } from '@np-shop-monorepo/service/prisma';
import {
  InitialRole1,
  InitialRole2,
  InitialRole3,
...
export class SeedAuthnService {
  constructor(@Inject(AuthPrismaService) private prisma: AuthPrismaService) {}
